...
use pc_keyboard::{HandleControl, Keyboard, ScancodeSet1, layouts, KeyCode as Ps2KeyCode};
use spin::Mutex;
use turnix_abi::input::{
    ...
    KEY_U, KEY_I, KEY_O, KEY_P, KEY_LBRACE, KEY_RBRACE, KEY_ENTER, KEY_LCTRL, KEY_A, KEY_S,
    KEY_D, KEY_F, KEY_G, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON, KEY_QUOTE, KEY_BACKTICK,
    KEY_LSHIFT, KEY_BACKSLASH, KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_N, KEY_M, KEY_COMMA,
    KEY_DOT, KEY_SLASH, KEY_RSHIFT, KEY_KP_ASTERISK, KEY_LALT, KEY_SPACE, KEY_CAPSLOCK,
    KEY_F1, KEY_F2, KEY_F3, KEY_F4, KEY_F5, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_F10,
    KEY_NUMLOCK, KEY_SCROLLLOCK, KEY_KP7, KEY_KP8, KEY_KP9, KEY_KP_MINUS, KEY_KP4, KEY_KP5,
    KEY_KP6, KEY_KP_PLUS, KEY_KP1, KEY_KP2, KEY_KP3, KEY_KP0, KEY_KP_DOT, KEY_F11, KEY_F12,
    KEY_KP_ENTER, KEY_RCTRL, KEY_KP_DIVIDE, KEY_RALT, KEY_HOME, KEY_UP, KEY_PAGEUP, KEY_LEFT,
...
pub fn hid_usage_to_ascii(usage: u8) -> Option<char> {
    match usage {
        ...
        0x1E => Some('1'), 0x1F => Some('2'), 0x20 => Some('3'),
        0x21 => Some('4'), 0x22 => Some('5'), 0x23 => Some('6'),
        0x24 => Some('7'), 0x25 => Some('8'), 0x26 => Some('9'),
        0x27 => Some('0'),
        0x28 => Some('\n'),           // Enter
...
mod tests {
    ...
    fn ps2_all_variants_mapped() {
        ...
        let all = [
            ...
            PrintScreen, SysRq, ScrollLock, PauseBreak,
            Oem8, Key1, Key2, Key3, Key4, Key5, Key6, Key7, Key8, Key9, Key0,
            OemMinus, OemPlus, Backspace,
            Insert, Home, PageUp,
            NumpadLock, NumpadDivide, NumpadMultiply, NumpadSubtract,
            Tab, Q, W, E, R, T, Y, U, I, O, P,
            Oem4, Oem6, Oem5, Oem7,
            Delete, End, PageDown,
            Numpad7, Numpad8, Numpad9, NumpadAdd,
            CapsLock, A, S, D, F, G, H, J, K, L, Oem1, Oem3,
            Return,
            Numpad4, Numpad5, Numpad6,
            LShift, Z, X, C, V, B, N, M, OemComma, OemPeriod, Oem2, RShift,
            ArrowUp,
            Numpad1, Numpad2, Numpad3, NumpadEnter,
            LControl, LWin, LAlt, Spacebar, RAltGr, RWin, Apps, RControl,
